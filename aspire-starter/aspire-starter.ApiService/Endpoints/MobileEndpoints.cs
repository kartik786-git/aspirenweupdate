...
{
    public static WebApplication MapMobileEndpoints(this WebApplication app)
    {
        var group = app.MapGroup("/api/mobile").WithOpenApi().RequireAuthorization();;
